    ...
    *,
    ...
    while placed < n_obstacles:
        for _ in range(MAX_ATTEMPTS_PER_OBS):
            ...
            # OK CRITICAL FIX: Add the obstacle to placed_obstacles list to prevent overlapping
        ...
        if PLATFORM:
            ...
            surface_visual = p.createVisualShape(
                ...
                rgbaColor=[
                    ...
                    0.4,
                    0.9,
                ],  # Bright glowing green with slight transparency
            ...
            flat_landing_uid = p.createMultiBody(
                ...
                basePosition=[
                    gx,
                    gy,
                    gz + surface_height + 0.002,
                ],  # Exactly on green surface
                physicsClientId=cli,
            )
            ...
            p.createMultiBody(
                ...
                basePosition=[
                    gx,
                    gy,
                    gz + surface_height + badge_height + 0.008,
            ...
            tao_logo_uid = p.createMultiBody(
                ...
                basePosition=[
                    gx,
                    gy,
                    gz + surface_height + badge_height + 0.011,
